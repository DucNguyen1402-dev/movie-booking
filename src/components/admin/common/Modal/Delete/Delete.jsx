  ...
  return (
    <div className="z-100 flex w-90 flex-col gap-4 rounded-xl border border-slate-700/60 bg-slate-800 p-6 text-slate-100 shadow-2xl shadow-black/90">
      ...
      <div className="mt-3 flex w-full items-center justify-center gap-2">
        <button
          className="bg-slate-750 grow cursor-pointer rounded-md border border-slate-700 py-1.5 text-sm font-medium text-slate-300 transition-colors duration-300 hover:bg-slate-700 hover:text-slate-100"
          onClick={onCancel}
        >
          Hủy
        </button>
