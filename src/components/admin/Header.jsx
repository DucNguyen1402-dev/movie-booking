...
export default function Header() {
  ...
  return (
    <header className={` transition-[padding] duration-300 ease-in-out will-change-transform sticky top-0 z-60 flex h-28 items-center border-b border-gray-800 bg-[#1e1e1e]/80 backdrop-blur-md ${isSidebarOpen ? "pl-8": "lg:pl-20 2xl:pl-10 "}`}>
