const MovieIcon = () => {
  ...
  return (
    <div
      className={`group/inner relative flex h-8 w-10 items-center justify-center rounded-md border border-slate-700/50 bg-linear-to-br from-red-800 via-red-700 to-red-600 shadow-xl transition-all duration-300 group-hover/outer:scale-105 group-hover/outer:shadow-cyan-500/20`}
    >
