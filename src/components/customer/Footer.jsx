...
import { MessageCircle, Music2, Play, Star } from "lucide-react";
    ...
    <footer className="border-t border-white/10 bg-gradient-to-br from-[#6536b8] to-[#2563d8]">
      <div className="cine-container py-14">
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.4fr]">
          <div>
            <Link to="/" className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl leading-none font-black uppercase">
                  CineBooking
                </p>

                <p className="mt-2 text-sm font-bold text-white/80 uppercase">
                  Be happy, be a star
                </p>
              </div>
            </Link>
            ...
            <div className="mt-7 flex gap-3">
              <Link to="/movies" className="cine-btn-yellow flex-1 px-4">
                Đặt vé
              </Link>
          ...
          <div>
            <h3 className="mb-5 font-black uppercase">Tài khoản</h3>
          ...
          <div>
            <h3 className="mb-5 font-black uppercase">Xem phim</h3>
            ...
            <ul className="space-y-3 text-sm font-medium text-white/85">
              ...
              <li>
                <Link to="/movies">Suất chiếu đặc biệt</Link>
              </li>
            </ul>
          </div>

          <div>
            <h3 className="mb-5 font-black uppercase">Dịch vụ khác</h3>
          ...
          <div>
            <h3 className="mb-5 font-black uppercase">Hệ thống rạp</h3>

            <ul className="space-y-3 text-sm font-medium text-white/85">
              {cinemaList.map((cinema) => (
                <li key={cinema}>{cinema}</li>
              ))}
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-white/30 pt-6 text-center text-sm font-medium text-white/75">
          © 2026 CineBooking Movie Capstone. Designed for ReactJS Capstone.
        </div>
      </div>
    </footer>
  );
