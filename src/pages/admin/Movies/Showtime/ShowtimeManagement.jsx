  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 py-10">
      <div className="mx-auto mt-2 flex max-w-[90%] gap-4 space-y-2">
        <section className="w-90 rounded-xl border border-slate-300 bg-slate-400 px-3 pt-4 pb-3 shadow-sm">
          <div className="flex flex-col items-center justify-center gap-4">
            <div className="flex items-center gap-2">
              <Clapperboard className="size-7 text-red-600" />
            ...
            <div className="flex items-center justify-center overflow-hidden rounded-md">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQA4im0lMdS6IyfT_qk_ZqEKipxM4fXGfe-gZlLhGWXnA&s=10"
                alt=""
                className="w-80"
              />
            </div>
            <button
              ...
              className="mt-6 flex cursor-pointer items-center gap-1 self-end rounded-md bg-green-500 px-3 py-2 text-sm font-medium text-white transition-colors duration-300 hover:bg-green-600"
            >
