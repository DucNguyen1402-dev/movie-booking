  ...
  return (
    ...
    >
      <td className="py-4 pl-8 font-mono text-slate-400">
        #{normalizedMovie.maPhim}
      </td>

      <td className="flex items-center gap-3 overflow-hidden px-6 py-4">
        <img
          src={normalizedMovie.hinhAnh}
          alt={normalizedMovie.tenPhim}
        ...
        <div className="flex flex-col gap-1">
          <span className="block text-sm font-semibold text-slate-200 transition-colors group-hover:text-yellow-400">
            {normalizedMovie.tenPhim}
          </span>

          <span className="font-mono text-xs text-slate-500">
            {normalizedMovie.biDanh}
          </span>
          {normalizedMovie.hot && (
      ...
      <td className="px-4 py-4 text-slate-300">
        {format(normalizedMovie.ngayKhoiChieu, "dd/MM/yyyy")}
      </td>
      ...
      <td className="px-4 py-4">
        <div className="flex flex-col gap-1.5">
          ...
          {!normalizedMovie.dangChieu && !normalizedMovie.sapChieu && (
