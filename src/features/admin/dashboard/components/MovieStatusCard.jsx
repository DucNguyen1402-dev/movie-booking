    ...
    <div className="group relative overflow-hidden rounded-2xl border border-gray-800/80 bg-[#141414] p-8 transition-all duration-300 hover:border-red-500/30 hover:shadow-[0_0_30px_rgba(239,68,68,0.07)]">
      ...
      <div className="relative z-10 flex h-full flex-col justify-between space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex h-12 w-12 items-center justify-center rounded-xl  bg-red-500/10 text-red-500 transition-colors duration-300  group-hover:text-red-600  group-hover:border group-hover:border-red-500">
        ...
        <div className="mt-2 flex items-center justify-between border-t border-gray-900 pt-4">
          ...
          <Link
            to="/admin/movies"
            className="flex h-8 items-center gap-1 rounded-lg border border-gray-800 bg-gray-900 px-3 text-xs font-medium text-gray-400 transition-all hover:bg-gray-800 hover:text-white"
          >
            <span> Chi tiết</span>
